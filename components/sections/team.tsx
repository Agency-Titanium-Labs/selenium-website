...
function TeamMemberCard({ member }: { member: (typeof teamMembers)[number] }) {
  ...
  return (
    <li
      ref={cardRef}
      className={twMerge(
        "group team-member-card relative bg-grey-lightest/10 backdrop-blur-md w-full sm:max-w-3xs",
    ...
    >
      ...
      <ul
        className={twMerge(
          "absolute top-4 right-4 flex flex-col gap-2 opacity-50 transition-opacity duration-500 ease-in-out delay-0",
          "group-hover:opacity-100 group-hover:z-10 group-hover:delay-200",
          "group-[.is-active]:opacity-100 group-[.is-active]:z-10 group-[.is-active]:delay-200",
        )}
      >
      ...
      <Image
        ...
        height={500}
        className={twMerge(
          "relative w-full h-auto mt-8 scale-110 origin-top transition-transform duration-500 ease-in-out delay-100",
          "group-hover:scale-85 group-hover:delay-0",
          "group-[.is-active]:scale-85 group-[.is-active]:delay-0",
        )}
        style={{
          WebkitMaskImage:
      ...
      <div
        className={twMerge(
          "absolute bottom-0 left-0 w-full flex flex-col items-center gap-4 p-4 bg-grey-darkest/60 backdrop-blur-xs text-xl transform translate-y-[calc(100%-2rem-1.2em)] transition-transform duration-500 ease-in-out",
          "group-hover:translate-y-0 group-hover:delay-50",
          "group-[.is-active]:translate-y-0 group-[.is-active]:delay-50",
        )}
        style={
          {
            "--corner-size": "20px",
          ...
          style={
            {
              "--corner-size": "20px",
              "--border-width": "2px",
              "--bg-pos-normal": "center bottom calc(-100% - 2rem - 1.2em)",
